class Personaje:
    ...
    def escoger_habilidad(self):
        ...
        elif opcion == "2" or opcion.lower() == "bastón" or opcion.lower() == "Baston de Paragons":
            self.inteligencia *= 3
            self.habilidad_escogida="Baston de Paragons"
    ...
    def mostrar_habilidades(self):
        ...
        print(f"{estilo['negrita']}Habilidad:{estilo['reset']} {self.habilidad_escogida}\n") 